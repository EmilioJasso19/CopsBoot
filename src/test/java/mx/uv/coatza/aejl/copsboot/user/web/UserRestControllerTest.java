...
import mx.uv.coatza.aejl.copsboot.user.*;
...
@WebMvcTest(UserRestController.class) // Enfócate solo en el controlador
...
public class UserRestControllerTest {
    ...
    @Mock // Mock de UserService con Mockito
    ...
    void givenAuthenticatedOfficer_userIsCreated() throws Exception {
        ...
        mockMvc.perform(post("/api/users")
                        .with(jwt().jwt(builder -> builder.subject(UUID.randomUUID().toString()))
                                .authorities(new SimpleGrantedAuthority("ROLE_OFFICER")))  // <--- Añadir rol
            ...
            """))
                ...
                .andExpect(jsonPath("authServerId").value("eaa8b8a5-a264-48be-98de-d8b4ae2750ac"));  // <--- Corregir UUID
    }
